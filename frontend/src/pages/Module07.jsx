...
export default function Module07() {
  ...
  const attackSteps = [
    "[RECON] Scanning employee home IP for IoT devices...",
    "[FOUND] Smart TV — CVE-2023-28529 (RCE, CVSS 9.1)",
    "[EXPLOIT] Crafted Miracast packet → code execution...",
    "[PIVOT] Work laptop discovered at 192.168.1.23...",
    "[CREDS] VPN credentials extracted from memory...",
    "[ACCESS] ⚠ Connected to FinsecCorp corporate network",
  ]
  ...
  return (
    <div>
      <ModuleHeader
        num="07"
        title="Smart Home Pivot"
        subtitle="Exploit home network to reach corporate VPN"
        badges={["CRITICAL","T1133","T1021"]}
      />
      <div style={{padding:"20px 24px"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",
                     gap:12,marginBottom:16}}>
          <StatCard label="Remote Workers" value="62%" color="#06b6d4"/>
          <StatCard label="Home IoT" value="11.7" color="#f97316"/>
          <StatCard label="VPN Exposed" value="89%" color="#ef4444"/>
          <StatCard label="Detection" value="12%" color="#eab308"/>
        </div>
